            ...
            <section class="relative overflow-hidden border-b border-gray-900 bg-[radial-gradient(circle_at_top_right,_rgba(29,155,240,0.2),_transparent_30%),linear-gradient(160deg,_#020202_0%,_#0a0a0a_55%,_#111111_100%)] px-6 py-10 lg:border-b-0 lg:border-r lg:px-12 lg:py-14">
                ...
                <div class="relative mx-auto flex h-full max-w-xl flex-col justify-between">
                    ...
                    <div class="py-16 lg:py-0">
                        <p class="text-sm uppercase tracking-[0.35em] text-sky-400/90">Create account</p>
                        <h1 class="mt-5 max-w-lg text-5xl font-black leading-[0.95] tracking-tight text-white sm:text-6xl">
                            Join the library, keep it simple.
                        </h1>
                        <div class="mt-10 grid gap-4 sm:grid-cols-2">
                            <div class="rounded-3xl border border-gray-800 bg-white/5 p-5">
                                <div class="text-sm font-semibold text-white">Quick start</div>
                                <div class="mt-2 text-sm leading-6 text-gray-400">Buat akun dalam beberapa langkah saja.</div>
                            </div>
                            <div class="rounded-3xl border border-gray-800 bg-white/5 p-5">
                                <div class="text-sm font-semibold text-white">Clean flow</div>
                                <div class="mt-2 text-sm leading-6 text-gray-400">Tidak ada elemen yang mengganggu fokus.</div>
                            </div>
                        </div>
                    </div>

                    <div class="relative mt-10 flex flex-wrap gap-3 text-xs text-gray-500">
                        <span class="rounded-full border border-gray-800 bg-black/60 px-3 py-1">Minimal signup</span>
                        <span class="rounded-full border border-gray-800 bg-black/60 px-3 py-1">Dark UI</span>
                        <span class="rounded-full border border-gray-800 bg-black/60 px-3 py-1">Mobile friendly</span>
                    </div>
                </div>
            </section>
            ...
            <section class="flex items-center justify-center px-6 py-10 sm:px-10">
                <div class="w-full max-w-md">
                    <div class="rounded-[2rem] border border-gray-800 bg-[#0d0d0d] p-8 shadow-2xl shadow-black/50">
                        <div class="mb-8">
                            <div class="text-sm uppercase tracking-[0.35em] text-gray-500">New here</div>
                            <h2 class="mt-3 text-3xl font-black text-white">Create account</h2>
                            <p class="mt-2 text-sm leading-6 text-gray-400">Daftar untuk mulai memakai sistem perpustakaan.</p>
                        </div>

                        <form @submit.prevent="submit" class="space-y-5">
                            <div>
                                <label for="name" class="mb-2 block text-sm font-semibold text-gray-300">Name</label>
                                <input
                                    id="name"
                                    v-model="form.name"
                                    type="text"
                            ...
                            <div>
                                <label for="password_confirmation" class="mb-2 block text-sm font-semibold text-gray-300">Confirm Password</label>
                                <div class="relative">
                                    <input
