        ...
        <div class="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                    <div class="max-w-3xl">
                        ...
                        <p class="mt-4 max-w-2xl text-sm leading-6 text-gray-400 sm:text-base">
                            Ubah detail buku tanpa menyentuh stok. Stok sekarang diatur lewat halaman khusus agar alurnya tetap rapi.
                        </p>
                    </div>

                    <a :href="route('books.index')" class="rounded-full bg-white px-5 py-3 text-sm font-bold text-black transition hover:bg-gray-200">
                        Kembali
                    </a>
                </div>
            </section>
            ...
            <div class="mt-8 grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
                <aside class="rounded-[2rem] border border-gray-800 bg-[#0b0b0b] p-6 shadow-2xl shadow-black/20">
                    <div class="text-xs uppercase tracking-[0.35em] text-gray-500">Book snapshot</div>
                    <div class="mt-4 rounded-[1.75rem] border border-gray-800 bg-white/5 p-5">
                        <div class="text-sm text-gray-400">Stok saat ini</div>
                        <div class="mt-1 text-4xl font-black text-white">{{ book.stock }}</div>
                        <div class="mt-4 text-sm leading-6 text-gray-400">
                            Ubah stok di halaman khusus supaya data lain tidak ikut berubah.
                        </div>
                        <a :href="route('books.stock.edit', book.id)" class="mt-5 inline-flex rounded-full bg-white px-4 py-3 text-sm font-bold text-black transition hover:bg-gray-200">
                            Ubah stok
                        </a>
                    </div>
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <div class="mt-3">
                                ...
                                />
                                <p class="mt-2 text-xs text-gray-500">Kalau cover ada di server, isi path-nya. Jangan pakai `public/storage/...`, pakai `/storage/...`.</p>
                            </div>
                        </div>
                        ...
                        <div class="grid gap-5 sm:grid-cols-2">
                            <div>
                                ...
                                <input v-model="form.title" type="text" class="w-full rounded-2xl border border-gray-800 bg-black px-4 py-3 text-white placeholder:text-gray-600 focus:border-white focus:outline-none" />
                            ...
                            <div>
                                ...
                                <input v-model="form.author" type="text" class="w-full rounded-2xl border border-gray-800 bg-black px-4 py-3 text-white placeholder:text-gray-600 focus:border-white focus:outline-none" />
                        ...
                        <div class="grid gap-5 sm:grid-cols-2">
                            <div>
                                ...
                                <input v-model="form.isbn" type="text" class="w-full rounded-2xl border border-gray-800 bg-black px-4 py-3 text-white placeholder:text-gray-600 focus:border-white focus:outline-none" />
                            ...
                            <div>
                                ...
                                <input v-model="form.publisher" type="text" class="w-full rounded-2xl border border-gray-800 bg-black px-4 py-3 text-white placeholder:text-gray-600 focus:border-white focus:outline-none" />
                        ...
                        <div class="flex flex-col gap-3 pt-2 sm:flex-row">
                            ...
                            <button type="button" @click="deleteBook" class="rounded-full border border-red-900/40 bg-red-950/40 px-6 py-3 text-sm font-bold text-red-300 transition hover:bg-red-900/60">
                                Hapus
                            </button>
